<html>
<head>
<title>Peñarol vs. Nacional (Copas Internacionales)</title>
...
<table width="300" border="0" cellspacing="0" cellpadding="0">
  <tr bgcolor="black" align="right"> 
    <td width="300" height="15" class="TexVer1Blanca"> <b>Pe&ntilde;arol vs. Nacional (Copas Internacionales)&nbsp;&nbsp;&nbsp;</b></td>
  </tr>
</table>
<?
include "../../include/db_connect.inc";
$query1="SELECT id,torneo,dia,mes,anio,condicion,resultado,referi FROM penarol_nacional_int WHERE anio='$anio'";
...
<table width="300" border="0" cellspacing="0" cellpadding="0">
  <tr> 
	...
	<table width="298" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td width="147" bgcolor="#A8A8A8" class="TexVer1Blanca">&nbsp;&nbsp;Torneo:</td>
          <td bgcolor="#000000" width="1"><img src="../../img/img_general/spacer.gif" width="1" height="15"></td>
          <td width="150" bgcolor="#E0E0E0" class="TexVer1Negro"><b>&nbsp;&nbsp;</b><? echo $row->torneo?></td>
        </tr>
      </table>
      <table width="298" border="0" cellspacing="0" cellpadding="0">
        <tr> 
...
<table width="298" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td width="147" bgcolor="#A8A8A8" class="TexVer1Blanca">&nbsp;&nbsp;Refer&iacute;:  
          </td>
          <td bgcolor="#000000" width="1"><img src="../../img/img_general/spacer.gif" width="1" height="15"></td>
          <td width="150" bgcolor="#E0E0E0" class="TexVer1Negro">&nbsp;&nbsp;<? echo $row->referi?></td>
        </tr>
      </table>
      <table width="298" border="0" cellspacing="0" cellpadding="0">
        <tr> 
