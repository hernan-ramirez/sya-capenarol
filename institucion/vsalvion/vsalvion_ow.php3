...
<table width="300" border="0" cellspacing="0" cellpadding="0">
  <tr bgcolor="black" align="right"> 
    <td width="300" height="15" class="TexVer1Blanca"> <b>Pe&ntilde;arol vs. Albion&nbsp;&nbsp;&nbsp;</b></td>
  </tr>
</table>
<?
include "../../include/db_connect.inc";
$query1="SELECT id,dia,mes,anio,estadio,ganador,resultado,condicion FROM penarol_albion WHERE anio='$anio'";
