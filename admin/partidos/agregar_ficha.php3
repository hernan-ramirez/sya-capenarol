              ...
              <div align="center"> 
                <select name="jugador1" size="1">
                  <?
					...
					?> 
                  <option value="<? echo $row->id ?>" selected> <?
					echo $row->nombre;
					?> &nbsp <? 
					echo $row->apellido;			
					?> </option>
