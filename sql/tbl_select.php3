<?php
/* $Id: tbl_select.php3,v 1.13 2000/08/05 12:14:04 tobias Exp $ */
...
?>
...
else
 {
    ...
    $sql_query .= " where 1";
       ...
       Header("Location:sql.php3?sql_query=".urlencode($sql_query)."&goto=db_details.php3&server=$server&db=$db&table=$table&pos=0&sessionMaxRows=$sessionMaxRows");
  }
