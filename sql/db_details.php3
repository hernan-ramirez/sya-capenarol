<?php
/* $Id: db_details.php3,v 1.24 2000/07/13 15:12:48 tobias Exp $ */
...
$query = "?server=$server&db=$db&goto=db_details.php3";
?>
<hr>
<div align="left">
<ul>
...
<input type="hidden" name="goto" value="db_details.php3?db=<?php echo $db;?>">
...
<li>
<a href="sql.php3?server=<?php echo $server;?>&db=<?php echo $db;?>&sql_query=<?php echo urlencode("DROP DATABASE $db");?>&zero_rows=<?php echo urlencode($strDatabase." ".$db." ".$strHasBeenDropped);?>&goto=main.php3&reload=true"><?php echo $strDropDB." ".$db;?></a> <?php print show_docu("manual_Reference.html#Drop_database");?>
</ul>
</div>
<?php
