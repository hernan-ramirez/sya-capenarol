<? 
$result = mysql_query("select * from noticias_juveniles where nivel='1'");
...
<? 
$result = mysql_query("select * from noticias_juveniles where nivel='2'");
$row = mysql_fetch_array($result);
?>
...
<? 
$result = mysql_query("select * from noticias_juveniles where nivel='3'");
$row = mysql_fetch_array($result);
?> 
...
<? 
$result = mysql_query("select * from noticias_juveniles where nivel='4'");
$row = mysql_fetch_array($result);
?> 
...
<? 
$result = mysql_query("select * from noticias_juveniles where nivel='5'");
$row = mysql_fetch_array($result);
?> 
